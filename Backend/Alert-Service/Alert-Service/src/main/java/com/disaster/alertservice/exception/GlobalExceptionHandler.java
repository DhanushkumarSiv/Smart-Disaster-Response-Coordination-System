package com.disaster.alertservice.exception;

import com.disaster.alertservice.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleAlertNotFoundException(AlertNotFoundException ex, HttpServletRequest request) {
